...
public final class newjsp_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/menu3.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            function orgchart()\n");
      out.write("            {\n");
      out.write("                $(\"#userpage\").load(\"orgchart.jsp\");\n");
      out.write("            }\n");
      out.write("            function orgchart1(i)\n");
      out.write("            {\n");
      out.write("                var id=document.getElementById(i).value;\n");
      out.write("                $(\"#userpage\").load(\"innerchart.jsp\",{\"id\":id});\n");
      out.write("            }\n");
      out.write("            function userinfo()\n");
      out.write("            {\n");
      out.write("                $(\"#userinfo\").load(\"userinfo.jsp\");\n");
      out.write("                taskmonitor();\n");
      out.write("                return home();\n");
      out.write("            }\n");
      out.write("            function home()\n");
      out.write("            {\n");
      out.write("                $(\"#userpage\").load(\"userhome.jsp\");\n");
      out.write("            }\n");
      out.write("            function taskmonitor()\n");
      out.write("            {\n");
      out.write("                $(\"#taskmonitor\").load(\"taskmonitorcheck.jsp\");\n");
      out.write("            }\n");
...
String username=(String) session.getAttribute("username");
      ...
      out.write("\n");
      out.write("    <body onload=\" userinfo(), valid()\">\n");
      ...
      out.write("    <body>\n");
      out.write("        <div id=\"sm\">\n");
      out.write("            <button class=\"button button1\" onclick='{$(\"#userpage\").load(\"userhome.jsp\");}'><span>home</span></button>\n");
      out.write("            <button class=\"button button1\"><span>document security</span></button>\n");
      out.write("            <button class=\"button button1\" onclick=\"return orgchart()\"><span>organization chart</span></button>\n");
      out.write("            <button class=\"button button1\"><span>business processing</span></button>\n");
      out.write("            <button class=\"button button1\"><span>task monitering</span></button>\n");
      ...
      out.write("            <tr><td width=\"25%\" valign=\"top\" style=\"background:whitesmoke;\">\n");
      out.write("                                   \n");
      out.write("                    <div id=\"userinfo\"></div> \n");
      out.write("                    <br>\n");
      out.write("                        \n");
      out.write("                    <div id=\"taskmonitor\" height=\"50%\"></div>\n");
      out.write("                                \n");
      out.write("                         </td>\n");
      out.write("\n");
      out.write("                <td valign=\"middle\" align=\"center\" style=\"height:100%;width:100%;\">\n");
      out.write("                    <div id=\"userpage\">\n");
      out.write("                    habfnimf\n");
      out.write("                    </div>\n");
      out.write("                </td>\n");
      out.write("            </tr>\n");
